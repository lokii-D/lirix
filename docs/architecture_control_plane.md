...
| Session lifecycle is replay-safe and strict workflow is opt-in | `lirix/core/session.py`, `lirix/core/session_fsm.py` | `tests/test_core/test_session.py`, `tests/test_core/test_session_workflow_strict_happy_path.py` | `validation_session.lifecycle`, `timeline`, `decision_log` |
