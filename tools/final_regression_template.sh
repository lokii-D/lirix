...
python3 -m pytest -o addopts= -q tests/test_core/test_session_agent_timeline_order_happy_path.py
...
python3 -m pytest -o addopts= -q \
  ...
  tests/test_integrations/test_integration_payload_parse_feedback.py
...
python3 tools/harness.py test-monkeypatch-convention --strict
